...
export default function LocationForm() {
  ...
  return (
    <div className="w-full max-w-4xl bg-white rounded-2xl   mx-auto text-gray-800 p-6 sm:p-4">
      <form
      ...
      >
        ...
        <button
          ...
          disabled={loader}
          className={`bg-amber-500 text-white px-4 sm:px-8 py-2 rounded-lg sm:rounded-xl shadow-md hover:bg-amber-600 transition-all duration-200 flex items-center justify-center gap-2 w-full sm:w-98 ${
